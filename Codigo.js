...
if(dineroCofla >= 0.6 && dineroCofla < 1){
    ...
    alert("Lo siento cofla, no tienes el dinero suficiente para comprarte un helado");
};
...
if(dineroRoberto >= 0.6 && dineroRoberto < 1){
    ...
    alert("Lo siento roberto, no tienes el dinero suficiente para comprarte un helado");
};
...
if(dineroPedro >= 0.6 && dineroPedro < 1){
    ...
    alert("Lo siento pedro, no tienes el dinero suficiente para comprarte un helado");
};